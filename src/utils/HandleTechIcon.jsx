...
const HandleTechIcon = (tech) => {
  if (tech === "React JS")
    return (
      <Tooltip text={tech}>
        <ReactLogo size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Mongo DB")
    return (
      <Tooltip text={tech}>
        <MongodbLogo size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Express JS")
    return (
      <Tooltip text={tech}>
        <ExpressLogo size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Node JS")
    return (
      <Tooltip text={tech}>
        <NodeLogo size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Tailwind CSS")
    return (
      <Tooltip text={tech}>
        <Tailwind size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Bootstrap")
    return (
      <Tooltip text={tech}>
        <Bootstrap size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "SCSS")
    return (
      <Tooltip text={tech}>
        <SCSS size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Wordpress")
    return (
      <Tooltip text={tech}>
        <WordPress size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Laravel")
    return (
      <Tooltip text={tech}>
        <Laravel size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "JQuery")
    return (
      <Tooltip text={tech}>
        <Jquery size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "MySQL")
    return (
      <Tooltip text={tech}>
        <Mysql size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "JavaScript")
    return (
      <Tooltip text={tech}>
        <Javascript size={"h-5 md:h-6"} />
      </Tooltip>
    );
  else if (tech === "Next JS")
    return (
      <Tooltip text={tech}>
        <NextJS size={"h-5 md:h-6"} />
      </Tooltip>
    );
