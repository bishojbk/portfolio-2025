  ...
  return (
    <div className="w-full md:w-10 md:fixed md:bottom-0 md:left-2 lg:left-4 xl:left-7 md:right-auto md:z-10">
      <motion.ul className="flex flex-row md:flex-col items-center justify-center m-0 p-0 gap-5">
        ...
        >
          <a href="https://github.com/bishojbk" target="_blank">
            <GitHub />
          </a>
        </motion.li>
        <motion.li
        ...
        >
          <a href="https://www.linkedin.com/in/bisojbk/" target="_blank">
            <LinkedIn />
          </a>
        </motion.li>
        <motion.li
        ...
        >
          <a href="https://www.instagram.com/rje1247/" target="_blank">
            <Instagram />
          </a>
        </motion.li>
        <motion.li
