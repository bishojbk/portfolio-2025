...
const Contact = ({ setSelectedPage }) => {
  const handleClickButton = () => {
    window.location.href = "mailto:bishojbk@gmail.com";
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          question, a project idea, or just want to chat, my inbox is always
          open. Don’t hesitate to drop me a message—I'll do my best to respond
          as quickly as I can. Let’s create something amazing together!
        </motion.p>
